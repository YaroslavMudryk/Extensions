...
namespace Extensions.Repository
{
    public interface IAsyncReadRepository<TEntity> : IAsyncDisposable where TEntity: class
    {
        ...
        Task<IPagedList<TEntity>> GetPagedListAsync<TKey>(Expression<Func<TEntity, bool>> predicate = null, int page = 1, int countPerPage = 20, Expression<Func<TEntity, TKey>> orderBy = null, OrderType orderType = OrderType.Ascending);
